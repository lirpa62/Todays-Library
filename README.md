...
복잡한 설치 과정이나 무거운 서버 구축 없이, 다운로드 후 즉시 실행 가능한 포터블(Portable) 형태로 제공됩니다.

## ✨ 주요 기능 (Key Features)

### 1. 📊 직관적인 실시간 방문자 집계
- **대상별 카운팅:** 성인, 아동, 유아를 구분하여 원클릭으로 집계 가능
...
* **스플래시 스크린:** 실행 시 하얀 화면(White flash)을 방지하는 부드러운 페이드인 애니메이션을 적용했습니다.
...
앱 내부에서 사용된 오픈소스 패키지 및 폰트(Pretendard)에 대한 세부 라이선스 정보는 [THIRD-PARTY-LICENSES.md](THIRD-PARTY-LICENSES.md) 문서 또는 앱 내의 **[정보(i) 아이콘 > 라이선스 보기]** 에서 확인하실 수 있습니다.
